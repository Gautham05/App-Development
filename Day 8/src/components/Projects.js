    ...
    <div className={`dashboard-container ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      {isSidebarOpen && (
        <div className="sidebar sidebar-right">
          ...
          <ul>
            <div className='sideList'><Link to="/Task"  style={{ textDecoration: 'none',  listStyleType: 'none' }}>Tasks</Link></div>
            <div className='sideList'><Link to="/teammembers"  style={{ textDecoration: 'none',  listStyleType: 'none'  }}>Members</Link></div>
          </ul>
        </div>
      )}
    <Task/>
